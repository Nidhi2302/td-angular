...
export class HistoryService {
  ...
  bookingHistory = (params) => {
    return new Promise((resolve, reject) => {
      this.appHttpService.post(this.baseUrlBook + '/booking-history',params, {}, false).subscribe(res => {
  ...
  listingHistory = (params) => {
    return new Promise((resolve, reject) => {
      this.appHttpService.post(this.baseUrlList + '/listing-history',params, {}, false).subscribe(res => {
        console.log("inside history", res);
        resolve(res);
      }, err => {
        reject(err);
